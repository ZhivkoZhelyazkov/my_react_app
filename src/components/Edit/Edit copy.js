...
//         productService.update(product._id, productData)
//             .then(response => {
//                 navigate('/products');
//             });
//     };
...
//                             <input type="submit" id="save_btn" className="btn tm-btn-submit tm-btn ml-auto" value="Save" />
//                         </form>
//                     </div>
            ...
            <section id="tm-section-5" className="tm-section">
                <div className="tm-bg-transparent-black tm-contact-box-pad">
                    ...
                    <div className="row tm-page-5-content">
                        ...
                        <form className="edit-form form-group col-sm-12" method="POST" onSubmit={saveClickHandler}>
                            <div className="form-group">
                                <input
                                    type="text"
                                    id="edit_title"
                            ...
                            <Link id="cancel_btn" to={`/details/${product._id}`} className="btn tm-btn-submit tm-btn ml-auto">Cancel</Link>
                            <input type="submit" id="save_btn" className="btn tm-btn-submit tm-btn ml-auto" onSubmit={saveClickHandler} value="Save" />
                        </form>
                    </div>
